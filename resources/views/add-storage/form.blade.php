...
<div class="form-group mb-3">
    <label class="form-label">   Selecciona Servidor</label>
    <div>
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        ($errors->has('box') ? ' is-invalid' : ''), 'placeholder' => '']) }}
        {!! $errors->first('box', '<div class="invalid-feedback">:message</div>') !!}
        <small class="form-hint"><b>Ejemplo:</b> Fantec Src-4240X07</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint"><b>Ejemplo:</b> NAS, SAN, SCSI</small>
    </div>
</div>
